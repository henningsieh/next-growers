...
export const dateFormatterEnUS = new Intl.DateTimeFormat(
  "en-US",
  {
    month: "long",
    day: "numeric",
...
export const dateTimeFormatterEnUS = new Intl.DateTimeFormat(
  "en-US",
  {
    month: "long",
    day: "numeric",
...
export const formattedDateTimeEnUS =
  dateTimeFormatterEnUS.format(new Date(isoString));
// console.log(formattedDateTimeEnUS); // Output: "May 19, 2023, 06:36 PM"

// Format: 18. Mai 2023 (de-DE)
export const dateFormatterDeDE = new Intl.DateTimeFormat(
  "de-DE",
  {
    day: "numeric",
    month: "long",
...
export const dateTimeFormatterDeDE = new Intl.DateTimeFormat(
  "de-DE",
  {
    day: "numeric",
    month: "long",
...
export const formattedDateTimeDeDE =
  dateTimeFormatterDeDE.format(new Date(isoString));
